...
<div class="container" style="width: 500px">
	<form method="POST" class="justify-content-center " enctype="multipart/form-data">
		<h3 class="mt-4"> Share your journey</h3><br>
		<h3 class="mt-4"> Upload your writeups here!</h3>
		<input type="file" name="image" accept="image/*,.pdf, .doc" required id="image">
		<br><br>
...
<script type="text/javascript">
	function selected_image(){
		...
		if(image_name == ''){
			...
			var ext = ["gif","png","jpeg","jpg","pdf","doc"];
